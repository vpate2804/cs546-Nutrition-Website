...
const main = async () => {
  try {
    let searchres = await recipes.getRecipeByName("Omlette");
  ...
  /* let newOne = await recipes.updateRecipe(
    "619175c82777e6387f6d3a1f",
    "Test2",
    { egg: 2, suger: "1/4 cups" },
    10,
    5,
    "Breakfast",
    ["Grains", "meat"],
  ...
  /* try {
    let newOne = await recipes.createRecipe(
      "text",
      { egg: "2", suger: "1/4 cups" },
      10,
      5,
  ...
  console.log(getAll);
  try {
    let newOne = await comments.createComment(
      "6191957bb65f99424157cdc2",
      "6191957bb65f99424157cdc3",
      "123zxc"
    );
  ...
  try {
    let newOne = await comments.getAllCommentsByRecipeId(
      "6191957bb65f99424157cdc2"
    );
